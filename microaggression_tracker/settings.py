"""
Django settings for microaggression_tracker project.
...
SECRET_KEY = '-vnv2-*o$dt)q4q4fl*=ku4yzq*n@ohw_r4i6^(&*d907(^8o1'
...
ROOT_URLCONF = 'microaggression_tracker.urls'
...
WSGI_APPLICATION = 'microaggression_tracker.wsgi.application'
